...
export default function ProfilePage() {
  ...
  const handleSubmit = () => {
    ...
    updateEmployee(
      {
        // PUT /employees/updatemyprofile — backend identifies user via JWT token
        // sends only the fields the backend actually reads:
        // firstName, secondName, lastName, phone, birthDate, gender, bloodGroup
        // NOTE: email is intentionally excluded — backend ignores it (commented out server-side)
        ...
        adharNumber: form.adharNumber ? Number(form.adharNumber) : null,
            ...
            <SectionCard title="Contact Details" icon="📞">
              <div className={styles.formGrid}>
                <Field label="Email Address" full>
                  ...
                  >
                    ℹ Email address cannot be changed
                  </span>
                </Field>
                <Field label="Phone Number">
                  <input
