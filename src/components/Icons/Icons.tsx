...
// export const PreSalesIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
//   <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// export const PostSalesIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
//   <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// export const ClientsIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
//   <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// export const BillingIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
//   <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//     <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
//     <polyline points="14 2 14 8 20 8" />
...
// export const HRIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
//   <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// export const PowerIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
//   <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const PostSalesIcon: React.FC<IconProps> = ({
  className,
  size = 20,
}) => (
  <svg
...
export const InvoiceIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const UserOffIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const VoucherIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const iconMap: Record<string, React.FC<IconProps>> = {
  ...
  // Sub-item icons (matches navigationData icon strings)
  plus: PlusIcon,
  list: ListIcon,
  folder: FolderIcon,
  invoice: InvoiceIcon,
